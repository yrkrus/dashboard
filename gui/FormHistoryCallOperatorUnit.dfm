object FormHistoryCallOperator: TFormHistoryCallOperator
  ...
  object lblOpenExcel: TLabel
    Left = 581
    Top = 101
    Width = 114
    Height = 17
    Cursor = crHandPoint
    Hint = #1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1090#1077#1082#1091#1097#1091#1102' '#1080#1089#1090#1086#1088#1080#1102' '#1079#1074#1086#1085#1082#1086#1074' '#1074' Excel'
    Alignment = taRightJustify
    Caption = '&'#1086#1090#1082#1088#1099#1090#1100' '#1074' Excel'
    Font.Charset = RUSSIAN_CHARSET
    Font.Color = clBlue
    Font.Height = -13
    Font.Name = 'Tahoma'
