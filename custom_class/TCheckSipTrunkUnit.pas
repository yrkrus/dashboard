...
///                                                                           ///
///                                                                           ///
///                   Класс для описания ChekSipTrunk                        ///
///                                                                           ///
///                                                                           ///
/////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////
 ...
 type
      ...
      procedure Check;        // внутренняя проверка состояние sip транков
      function GetStateTrunk(_id:Integer):enumTrunkStatus;  // статус транка
      function GetTimeUpdate(_id:Integer):string;  // время обновления статуса транка
...
begin
  ...
  SetLength(m_listTrunk, 0); // Убираем массив
...
// внутренняя проверка состояние sip транков
...
// время обновления статуса транка
      ...
      with p_formCheckTrunks do begin
        ...
        for j:=0 to ComponentCount-1 do begin
          if Components[j].Name='lbl_'+IntToStr(m_listTrunk[i].id) then begin
            if m_listTrunk[i].is_alive then begin  // НЕТ ОШИБКИ!!
          ...
          case allCountErrors of
           ...
           viewErrors:=0;
            ...
            if viewErrors>=2 then begin
             p_checkTrunkInfo.Caption:=p_checkTrunkInfo.Caption+' и еще '+IntToStr(allCountErrors-2)+' (нажмите сюда для показа...)';
            end;
          end;
        end;
