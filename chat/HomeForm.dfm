  ...
  object PanelSend: TPanel
    ...
    object PanelSendMessage: TPanel
      ...
      object STMessageInfo1: TStaticText
        ...
        Width = 311
        Height = 20
        Caption = 'ctrl+enter '#1080#1083#1080' shift+enter '#1087#1077#1088#1077#1093#1086#1076' '#1085#1072' '#1085#1086#1074#1091#1102' '#1089#1090#1088#1086#1095#1082#1091
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object STMessageInfo3: TStaticText
        ...
        Height = 20
        Caption = 
          #1076#1083#1103' '#1083#1080#1095#1085#1099#1093' '#1089#1086#1086#1073#1097#1077#1085#1080#1081' 2 '#1088#1072#1079#1072' '#1082#1083#1080#1082#1085#1080#1090#1077' '#1085#1072' '#1087#1086#1083#1100#1079#1086#1074#1072#1090#1077#1083#1103' '#1080#1079' '#1089#1087#1080#1089#1082#1072' "' +
          #1054#1085#1083#1072#1081#1085'"'
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
